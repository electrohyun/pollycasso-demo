    ...
    <div className="flex items-center w-[850px] h-[90px] px-8 py-5 bg-gradient-to-r rounded-3xl from-[#909090] to-[#D4D4D4] gap-x-4 shadow-[inset_0_4px_10px_rgba(0,0,0,0.2)]">
      <div className="flex flex-none gap-x-3">
        <div className="w-14 h-14 bg-white rounded-xl flex justify-center items-center cursor-pointer hover:bg-gray-100 shadow-sm">
          <PencilIcon className="w-6 h-6 text-[#909090]" />
        </div>

        <div className="w-14 h-14 bg-white rounded-xl flex justify-center items-center cursor-pointer hover:bg-gray-100 shadow-sm">
          <PaintBrushIcon className="w-6 h-6 text-[#909090]" />
        </div>

        <div className="w-14 h-14 bg-white rounded-xl flex justify-center items-center cursor-pointer hover:bg-gray-100 shadow-sm">
          <PencilSquareIcon className="w-6 h-6 text-[#909090]" />
        </div>
      </div>

      <div className="flex flex-col justify-between w-[175px] h-full">
        <div className="flex justify-between items-center px-2">
          <div className="w-[22px] h-[22px] rounded-full bg-white flex items-center justify-center cursor-pointer shadow-sm">
